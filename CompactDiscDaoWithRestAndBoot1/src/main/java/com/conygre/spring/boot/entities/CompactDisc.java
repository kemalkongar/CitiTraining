package com.conygre.spring.boot.entities;// This entity class uses annotations instead of the mapping XML file
...
@NamedQueries(
		{
				@NamedQuery(name="compactdisc.getAll",
						query="select cd from com.conygre.spring.boot.entities.CompactDisc as cd where cd.price > :price",
